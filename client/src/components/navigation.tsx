  ...
  return (
    <>
      ...
      {openDropdown === 'education' && (
        <div className="fixed top-20 left-1/2 transform -translate-x-1/2 w-auto max-w-4xl z-[9999] mt-2">
          <LiquidGlass 
            ...
            <div className="rounded-xl p-4">
              ...
              >
                <div className="space-y-1">
                  <h3 className="text-lg font-bold text-gray-900 dark:text-white">University of New Brunswick</h3>
                  <p className="text-base text-gray-700 dark:text-gray-300">Bachelor of Business Administration</p>
                  <p className="text-sm text-gray-500 dark:text-gray-400">Fredericton, NB</p>
