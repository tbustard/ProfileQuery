      ...
      case "graduation":
        return (
          <svg className="w-8 h-8 text-blue-700" fill="currentColor" viewBox="0 0 24 24">
            <path d="M11.7 2.805a.75.75 0 0 1 .6 0A60.65 60.65 0 0 1 22.83 8.72a.75.75 0 0 1-.231 1.337 49.948 49.948 0 0 0-9.902 3.912l-.003.002c-.114.06-.227.119-.34.18a.75.75 0 0 1-.707 0A50.88 50.88 0 0 0 7.5 12.173v2.176a3 3 0 0 0 1.506 2.604l1.413.817a.75.75 0 0 1-.069 1.36l-.84.35a.75.75 0 0 1-.96-.526L8.11 17.8c-.365-.632-1.267-.632-1.632 0l-.46 1.154a.75.75 0 0 1-.96.526l-.84-.35a.75.75 0 0 1-.069-1.36l1.413-.817a3 3 0 0 0 1.506-2.604v-2.176A50.88 50.88 0 0 0 1.921 10.057.75.75 0 0 1 1.69 8.72A60.65 60.65 0 0 1 11.7 2.805ZM13.06 15.931a.75.75 0 0 1 .831.24 3.75 3.75 0 0 0 2.716 1.296 3.75 3.75 0 0 0 2.716-1.296.75.75 0 0 1 1.162.956 5.25 5.25 0 0 1-3.878 1.81 5.25 5.25 0 0 1-3.878-1.81.75.75 0 0 1 .331-1.196Z" />
          </svg>
        );
      default:
        return null;
